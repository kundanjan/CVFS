...
void InitialiseUAREA()
{
    ...
    cout<<"Kundan CVFS : UAREA initialised succesfully\n";
}
...
void InitialiseSuperblock()
{
    ...
    cout<<"Kundan CVFS : Superblock initialised succesfully\n";
}
...
void CreateDILB()
{
    ...
    cout<<"Kundan CVFS : DILB created succesfully\n";
}
...
void StartAuxilaryDataInitialisation()
{
    ...
    cout<<"Kundan CVFS : Auxilary data initalised succesfully\n";
}
...
{
    printf("---------------------------------------------------------\n");
    printf("----------- Command Manual of Kundan CVFS -----------\n");
    printf("---------------------------------------------------------\n");

    printf("man : It is used to display the specific manual page of command\n");
    printf("exit : It is used to terminate the shell of Kundan CVFS\n");
    printf("clear : It is used to clear the console of Kundan CVFS\n");
            ...
            )
{
    ...
    {
        printf("Description : This command is used to terminate the Kundan CVFS\n");
...
int main()
{
    ...
    cout<<"---------------------------------------------------------\n";
    cout<<"--------- Kundan CVFS Started Succesfully ------------\n";
    cout<<"----------------------------------------------------------\n";
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            {
                printf("Thank you for using Kundan CVFS\n");
        ...
        {
            // Kundan CVFS > creat Ganesh.txt 3
